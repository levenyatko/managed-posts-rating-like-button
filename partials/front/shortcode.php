...
<div class="<?php echo esc_attr($classes); ?>"
      ...
      data-parent="<?php echo esc_attr( get_the_ID() ); ?>"
>
    <div class="mpr-tooltip" >
        <p></p>
    </div>
    <div class="mpr-button-row">
        <span class="mpr-votes-number"><?php echo esc_html( (int)$post_rating ); ?></span>
        <div class="mpr-votes-icon">
